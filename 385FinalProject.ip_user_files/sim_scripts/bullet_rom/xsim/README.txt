...
#
# Generated by export_simulation on Thu Dec 07 19:02:42 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './bullet_rom.sh' script.

./bullet_rom.sh -reset_run
...
./bullet_rom.sh -noclean_files

For more information on the script, please type './bullet_rom.sh -help'.
