...
HD_PWD='C:/Users/advai/lab6_2/lab6_2.runs/finished_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log finished_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source finished_rom.tcl
