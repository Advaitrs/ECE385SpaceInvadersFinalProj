...
HD_PWD='C:/Users/advai/lab6_2/lab6_2.runs/spaceship_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spaceship_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spaceship_rom.tcl
