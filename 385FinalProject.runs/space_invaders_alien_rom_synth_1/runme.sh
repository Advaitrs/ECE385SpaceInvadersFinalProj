...
HD_PWD='C:/Users/advai/lab6_2/lab6_2.runs/space_invaders_alien_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log space_invaders_alien_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source space_invaders_alien_rom.tcl
